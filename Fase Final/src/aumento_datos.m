...
nombres = [...
    ...
    "888_png.rf.a67e7e1bca399dd9a6f93c07dea9c1d5.jpg"...
    "264_png.rf.43a917f94cc73493b26b63d01e015184.jpg"
    ];

path = "E:/UTM\Maestria/PDI/Proyecto/Fase II -  Aumento de Datos/examples/original/";
new_path = "E:/UTM/Maestria/PDI/Proyecto/Fase II -  Aumento de Datos/examples/";
...
for i = 1:5
    ...
    I_ecualizada = ecualizar(I{i});
    
    % 3) Highboost
    k_hb = 5;
    I_highboost = highboost(I{i}, k_hb);
    
    % 4) Gradiente-Laplaciano
    I_gradLap = grad_lap(I{i});
        ...
        figure('Name', ['Mejoras de Imagen - Foto ' num2str(i)]);
        subplot(1, 3, 1); imshow(I_ecualizada, []); title('Ecualización');
        subplot(1, 3, 2); imshow(I_highboost, []); title('Highboost');
        subplot(1, 3, 3); imshow(I_gradLap, []); title('Gradiente-Laplaciano');
    ...
    imwrite(uint8(I_ecualizada), fullfile(outDir, name + "_ecualizada" + ".jpg"));
    imwrite(uint8(I_highboost), fullfile(outDir, name + "_highboost" + ".jpg"));
    imwrite(uint8(I_gradLap), fullfile(outDir, name + "_gradLap" + ".jpg"));
