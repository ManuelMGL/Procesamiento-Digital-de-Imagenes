...
nombres = [...
    ...
    "1059_jpg.rf.49ee257c3924b4a8e8f086d1472f91a6.jpg"...
...
num_bins = length(counts); % Esto te dará el número total de bins

cl = M*N/4 / num_bins * alpha;
